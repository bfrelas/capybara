...
module Capybara
  module Node
    module Matchers
      ...
      # @return [Boolean]                 Whether it exists
      #
      def has_checked_field?(locator, **options, &optional_filter_block)
      ...
      # @return [Boolean]                 Whether it doesn't exist
      #
      def has_no_checked_field?(locator, **options, &optional_filter_block)
      ...
      # @return [Boolean]                 Whether it exists
      #
      def has_unchecked_field?(locator, **options, &optional_filter_block)
      ...
      # @return [Boolean]                 Whether it doesn't exist
      #
      def has_no_unchecked_field?(locator, **options, &optional_filter_block)
